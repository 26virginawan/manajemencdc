        ...
        <div class="card" style="margin-left:auto;margin-right:auto;border-color: #fff;">
            <div class="card-body">
                <div class="table-wrapper">
                    ...
                    <table>
                        <tr>
                            <td><a href="input-siswa" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                                    Tambah Data</a></td>

                            <td><button type="button" class="btn btn-secondary btn-sm" data-toggle="modal"
                                    data-target="#staticBackdrop"><i class="fas fa-file-import"></i> Import
                                    Data</button></td>
                            <td><a href="export" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Export
                                    Data</a></td>
                        </tr>
                    </table>
                    <!--Modal Import -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel">Import Data Angsuran</h5>
                                    ...
                                    <form id="sample_form" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="file"><input type="text"
                                                        class="form-control rounded-lg" id="file1"
                                                        style="color: black; position: absolute; margin-left : -12px ;margin-top : -7px;"
                                                        for="file" placeholder="Upload csv file"></label>
                                            </div>
                                        </div>
                                </div>
                                <div class="modal-footer">
                                    <a href="code crud/data_siswa.csv" class="btn btn-success"
                                        download="data-siswa.csv">Download Csv</a>
                                    <input type="submit" name="import" id="import" class="btn btn-primary"
                                        value="Import" />
                                    </form>
                        ...
                        <table id="data_siswa" class="table table-bordered table-hover"
                            ...
                            <thead>
                                <tr style="text-align: center; height : 25px;">
                                    ...
                                    <th scope="col">ba</th>
                                    <th scope="col">cdsa</th>
                                    <th scope="col">provinsi</th>
                                    <th scope="col">kab/kota</th>
                                    <th scope="col">Tahun Salur</th>
                                    <th scope="col">Jenis Angsuran</th>
                                    <th scope="col">Kualitas</th>
                                    <th scope="col">Angsuran Akhir</th>
                                    <th scope="col">gljr</th>
                                    <th scope="col">Angsuran</th>
                                    <th scope="col">Angsuran Pokok</th>
                                    <th scope="col">Angsuran Jasa</th>
                                    <th scope="col">Adj Pojok</th>
                                    <th scope="col">Adj Jasa</th>
                                    <th scope="col">kelebihan</th>
                                    <th scope="col">pengembalian</th>
                                    <th scope="col">pendapatan</th>
                                    <th scope="col">C user</th>
