            ...
            <div class="card mt-5">
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                        <div class="row">
                            <div class="col">
                                <h5><span style="color: red;">*</span> Data Angsur</h5>
                                <div class="form-group">
                                    <input type="text" name="kode" class="form-control rounded-lg" placeholder="Kode"
                                        required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="tgl_reg" class="form-control rounded-lg"
                                        placeholder="Tgl Regristrasi" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="ttl" class="form-control rounded-lg"
                                ...
                                <div class="form-group">
                                    <input type="text" name="bb" class="form-control rounded-lg"
                                        placeholder="Berat Badan" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="tb" class="form-control rounded-lg"
                                        placeholder="Tinggi Badan" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="no_hp" class="form-control rounded-lg"
                                        placeholder="No. HP Atlet" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="foto_siswa" id="foto_siswa"
                                            required>
                                        <label class="custom-file-label" for="foto_siswa"><input type="text"
                                                class="form-control rounded-lg" id="foto_siswa1"
                                                style="color: black; position: absolute; margin-left : -12px ;margin-top : -7px;"
                                                for="foto_siswa" placeholder="Upload Foto Atlet"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <input type="text" name="nama_wali" class="form-control rounded-lg"
                                        placeholder="Nama Wali" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="no_hpwali" class="form-control rounded-lg"
                                        placeholder="No. HP Wali" required>
                                </div>
                                <div class="form-group">
                                    <textarea type="text" name="alamat_wali" class="form-control rounded-lg"
                                        placeholder="Alamat Lengkap Wali" required></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" name="input"><i class="fa fa-plus"
                                            aria-hidden="true"></i>&nbsp;Add Siswa</button>
                                </div>
                            </div>
                        </div>
                    </form>
